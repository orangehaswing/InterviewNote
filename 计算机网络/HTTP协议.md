...
- 多路复用：HTTP1中的Keep-Alive用于长连接而不必重新建立连接，然而keep-alive必须等本次请求彻底完成后才能发送下一个请求，而HTTP2的请求与响应以二进制帧的形式交错进行，只需建立一次连接，即一轮三次握手，实现多路复用。
  ...
  ![img](https://segmentfault.com/image?src=http://onepiece.b0.upaiyun.com/assets/http2request.png&objectId=1190000002765886&token=f87f46113623ab2c329df8b1434fa3b4)
