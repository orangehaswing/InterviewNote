...
[![img](https://github.com/CyC2018/CS-Notes/raw/master/docs/notes/pics/urlnuri.jpg)](https://github.com/CyC2018/CS-Notes/blob/master/docs/notes/pics/urlnuri.jpg)
...
101	  Switching Protocols        服务器根据客户端的请求切换协议，更高级的协议，例如，切换到HTTP的新版本协议
...
203	Non-Authoritative Information       非授权信息。请求成功。但返回的meta信息	不在原始的服务器，而是一个副本
...
304	    Not Modified        		未修改。所请求的资源未修改，服务器返回此状态码时不会返回任何资源。客户端通常会缓存访问过的资源，通过提供一个头信息指出客户端希望只返回在指定日期之后修改的资源
