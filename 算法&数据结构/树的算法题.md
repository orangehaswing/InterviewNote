...
public class BinTreeCreator {
	...
	public static BinTreeNode invertTree(BinTreeNode root) {
	    if (root == null) return null;
	    BinTreeNode left = root.getLeftChild();  // 后面的操作会改变 left 指针，因此先保存下来
	    root.setLeftChild(invertTree(root.getRightChild()));
	    root.setRightChild(invertTree(left));
	    return root;
	}
	...
	public static void main(String[] args) {
		...
		//rootNode = BinTreeCreator.invertTree(rootNode);
